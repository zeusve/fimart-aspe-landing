  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Clínica de fisioterapia en Aspe desde 2014. Terapia manual, rehabilitación funcional, EPI y ecografía MSK. Valoración 4.9★ en Google. Pide cita: 652 667 953."
        path="/"
