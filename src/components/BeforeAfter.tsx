...
const BeforeAfter = () => {
  ...
  return (
    ...
    >
      {/* Background accents */}
      <div className="absolute top-0 left-1/2 w-[600px] h-[600px] bg-secondary/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" aria-hidden="true" />

      <div className="container mx-auto relative z-10">
        {/* Asymmetric layout */}
        <div className="grid lg:grid-cols-[1fr,1.5fr] gap-12 lg:gap-16 items-center">
          {/* Left: Text content */}
          <motion.header
          ...
          >
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground font-body">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Tratamiento guiado</span>
              </div>
            </div>
          </motion.header>

          {/* Right: Interactive Before/After Component */}
          <motion.figure
          ...
          >
            <div
              className="relative aspect-[16/9] rounded-2xl overflow-hidden cursor-pointer group shadow-2xl shadow-primary/10"
            ...
            >
              ...
              <motion.div
                animate={{
                  boxShadow: isHovered
                    ? 'inset 0 0 60px hsl(162 85% 48% / 0.3)'
                    : 'inset 0 0 20px hsl(190 95% 50% / 0.15)'
                }}
