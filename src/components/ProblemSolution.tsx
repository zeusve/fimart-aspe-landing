  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed font-body text-center max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10 mb-16">
          {pillars.map((pillar, index) => (
            <motion.article
              ...
              className="group relative bg-background/50 backdrop-blur-sm border border-border rounded-2xl p-8 lg:p-10 hover:border-primary/30 transition-all duration-500"
            >
              ...
              <div className={`inline-flex items-center justify-center w-16 h-16 lg:w-20 lg:h-20 rounded-2xl border mb-6 ${colorMap[pillar.color].icon}`} aria-hidden="true">
                <pillar.icon className="w-8 h-8 lg:w-10 lg:h-10" />
              </div>
              <h3 className="font-display text-2xl lg:text-3xl font-bold text-foreground mb-4 tracking-wide">
                {pillar.title}
              </h3>
        ...
        >
          <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed font-body mb-10 max-w-4xl mx-auto">
